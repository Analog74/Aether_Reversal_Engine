...
LAB_1001f7dcb:
      ...
      for (puVar1 = *(uint **)(puVar1 + 8); puVar1 != (uint *)0x0; puVar1 = *(uint **)(puVar1 + 0xc)
        ...
        if ((*puVar1 & 0xf) - 3 < 2) goto LAB_1001f7dcb;
      }
    }
  }
  return param_1;
...
LAB_1001f7ceb:
      ...
      for (puVar2 = *(uint **)(puVar2 + 8); puVar2 != (uint *)0x0; puVar2 = *(uint **)(puVar2 + 0xc)
        ...
        if ((*puVar2 & 0xf) - 3 < 2) goto LAB_1001f7ceb;
      }
    }
  }
  return param_1;
...
void xml_text::as_string(char const*) const {
uint *puVar1;
...
LAB_1001f7c7e:
      if (*(char **)(puVar1 + 4) != (char *)0x0) {
        param_1 = *(char **)(puVar1 + 4);
      }
    }
    else {
      for (puVar1 = *(uint **)(puVar1 + 8); puVar1 != (uint *)0x0; puVar1 = *(uint **)(puVar1 + 0xc)
          ) {
        if ((*puVar1 & 0xf) - 3 < 2) goto LAB_1001f7c7e;
      }
    }
  }
  return param_1;
...
LAB_1001f7d5b:
      ...
      for (puVar2 = *(uint **)(puVar2 + 8); puVar2 != (uint *)0x0; puVar2 = *(uint **)(puVar2 + 0xc)
        ...
        if ((*puVar2 & 0xf) - 3 < 2) goto LAB_1001f7d5b;
      }
    }
  }
  return param_1;
