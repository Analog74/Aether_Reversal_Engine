...
LAB_1000bb13f:
          ...
          if (*(int *)(puVar6 + 4) == 2) {
            ...
            if (cVar4 == '\0') {
              // std code
              local_60 = PTR_vtable_1009cc1f8 + 0x10;
              puStack_58 = PTR_typeinfo_1009cc190;
              local_50 = PTR_typeinfo_1009cc138;
              // boost code
            ...
            local_48 = local_88;
            uStack_40 = uStack_80;
            local_88 = (void *)pugi::xml_node::append_child(param_1,(char *)puVar8[5]);
