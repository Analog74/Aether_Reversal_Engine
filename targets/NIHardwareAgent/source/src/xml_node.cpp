...
LAB_1001f4fba:
    ...
    if (uVar1 < 0x7fd9) {
      ...
      *(unsigned long *)(this_00 + 8) = uVar1;
      ...
      if (pxVar6 == (xml_memory_page *)0x0) goto LAB_1001f4fba;
    }
...
LAB_1001f5147:
    ...
    if (uVar1 < 0x7fd9) {
      ...
      *(unsigned long *)(this_00 + 8) = uVar1;
      ...
      if (pxVar5 == (xml_memory_page *)0x0) goto LAB_1001f5147;
    }
...
void xml_node::child_value() const {
uint *puVar1;
  
  puVar1 = *(uint **)this;
  if (puVar1 != (uint *)0x0) {
    if (((*puVar1 & 0xf) == 2) && (*(char **)(puVar1 + 4) != (char *)0x0)) {
      return *(char **)(puVar1 + 4);
    }
    for (puVar1 = *(uint **)(puVar1 + 8); puVar1 != (uint *)0x0; puVar1 = *(uint **)(puVar1 + 0xc))
    {
      if ((*(char **)(puVar1 + 4) != (char *)0x0) && ((*puVar1 & 0xf) - 3 < 2)) {
        return *(char **)(puVar1 + 4);
      }
    }
  }
