...
__tree_node *p_Var1;
  ...
  lVar2 = 0;
  p_Var1 = 0;
  local_20 = (anonymous_namespace)::s_setDebugTraceGroups;
  local_18 = 0;
  local_10 = 0;
  0 = (__tree_node *)0x0;
  0 = 0;
  ...
  local_20 = pp_Var3;
  (anonymous_namespace)::s_setDebugTraceGroups = &0;
  // std code
            ((__tree<// std code
             p_Var1);
  return;
...
unsigned long long *puVar1;
  ...
  param_1 = param_1 + 1;
LAB_1002e4bd6:
  puVar5 = (anonymous_namespace)::s_setDebugTraceGroups;
  if ((anonymous_namespace)::s_setDebugTraceGroups != &0) {
    do {
      ...
      if (cVar7 != '\0') {
        lVar4 = 0;
        do {
          if ((param_1[lVar4] == '\0') || (param_1[lVar4] != cVar7)) goto LAB_1002e4c60;
