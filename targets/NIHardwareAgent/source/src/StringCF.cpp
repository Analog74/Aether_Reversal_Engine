        ...
        if (uVar2 < 0x10001) {
          ...
          *(wchar16 **)(this + 8) = pwStack_50;
          ...
          if ((long)uVar2 < 0) {
            ...
            puStack_80 = &UNK_1002ecbb2;
            // std code
          }
          local_60 = uVar2 * 2;
          puStack_80 = (void *)0x1002ecb10;
          pwVar3 = (wchar16 *)new(local_60);
          local_48 = pwVar3 + uVar2;
          pwVar5 = (wchar16 *)((long)pwVar3 + local_60);
          puStack_80 = (void *)0x1002ecb31;
          local_58 = pwVar3;
          ___bzero(pwVar3);
          puStack_80 = (void *)0x1002ecb45;
          pwStack_50 = pwVar5;
          _CFStringGetCharacters(param_1,0,uVar2,pwVar3);
          puStack_80 = (void *)0x1002ecb54;
          StringUtil::fromUTF<char16_t>((StringUtil *)&local_78,pwVar3,uVar2);
          if (((byte)*this & 1) != 0) {
            puStack_80 = (void *)0x1002ecb63;
          ...
          *(unsigned long long *)(this + 8) = uStack_70;
          if (local_58 != (wchar16 *)0x0) {
            pwStack_50 = local_58;
            puStack_80 = (void *)0x1002ecb85;
            delete(local_58);
          }
        }
      }
      else {
        puStack_80 = (void *)0x1002eca5c;
        StringUtil::fromUTF<char16_t>((StringUtil *)&local_58,pwVar3,uVar2);
        if (((byte)*this & 1) != 0) {
          puStack_80 = (void *)0x1002eca6b;
          delete(*(void **)(this + 0x10));
        }
        *(wchar16 **)(this + 0x10) = local_48;
        *(wchar16 **)this = local_58;
