#include <ni/controller_editor/RigControl2.hpp>
namespace NI::NHL2::SERVER {

RigControl2::RigControl2() {
GuitarRig::Controller::Controller((Controller *)this,true);
  *(void ***)this = &PTR__RigControl2_1009cfdf8;
  *(void ***)(this + 0x2a8) = &PTR_setLEDColor_1009d00d8;
  *(void ***)(this + 0x2d8) = &PTR_getLEDDisplayCount_1009d0168;
