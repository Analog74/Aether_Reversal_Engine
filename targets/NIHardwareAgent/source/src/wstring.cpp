...
namespace std::wstring& std {

void wstring::__append_forward_unsafe<wchar_t*>(wchar_t*, wchar_t*) {
wstring *pwVar1;
  ...
  if ((pwVar1 <= param_1) && (param_1 < pwVar1 + uVar16 * 4)) {
    ...
    if (uVar13 < 5) {
      ...
      puVar17 = (unsigned int *)new(uVar15 * 4);
      local_48 = uVar15 | 1;
      local_38 = puVar17;
      local_40 = uVar13;
    }
  ...
  if (param_1 != param_2) {
    if ((0x1b < uVar14 - 4) &&
      ...
      if (uVar15 + 1 == uVar12) goto LAB_10030c7c1;
