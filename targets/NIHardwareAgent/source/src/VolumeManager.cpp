...
LAB_1002ffc3b:
  ...
  if ((0 < (int)uVar8) && (local_a0[0] != 0)) {
    ...
    do {
      uVar17 = local_a0[0];
      iVar9 = (anonymous_namespace)::getTypeByStatFS((statfs *)(local_a0[0] + uVar22 * 0x878));
      if (iVar9 != 0) {
        local_68 = 0;
        pvStack_60 = (void *)0x0;
        local_78 = (void *)0x0;
        ...
        if (sVar10 < 0x17) {
          ...
          if (sVar10 != 0) goto LAB_1002ff946;
        }
        else {
          uVar17 = sVar10 + 0x10 & 0xfffffffffffffff0;
          psVar11 = (string *)new(uVar17);
          local_48 = uVar17 | 1;
          sStack_40 = sVar10;
          local_38 = psVar11;
LAB_1002ff946:
        ...
        cVar7 = (anonymous_namespace)::isValidExistentVolume(psVar11,(VolumeInfo *)&local_88);
        if ((local_48 & 1) != 0) {
          psVar11 = local_38;
          delete(local_38);
        }
