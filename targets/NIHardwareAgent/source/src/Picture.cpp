    ...
    if (param_5 < 0xff000000) {
      ...
      if (param_3 < 0x10) {
        ...
        if (0 < param_3) {
          ...
          uVar7 = (uVar18 - 8 >> 3) + 1;
          uVar19 = (unsigned long)((uint)uVar7 & 7);
          uVar14 = uVar17 * 4;
...
LAB_100203cc8:
              ...
              if (uVar19 != 0) {
                lVar6 = 0;
                do {
                  puVar9 = (uint *)((long)puVar16 + lVar6 + lVar13 * 4);
                  *puVar9 = param_5;
                  puVar9[1] = param_5;
                  puVar9[2] = param_5;
                  puVar9[3] = param_5;
          ...
          if (0x10 < iVar11) {
            if (6 < iVar11 - 0x11U) {
              ...
              if (uVar15 - 8 < 0x38) {
                ...
                lVar6 = -((((unsigned long)uVar5 + 1 & 0xfffffffffffffff8) - 8 >> 3) + 1 &
                         0xfffffffffffffff8);
                lVar10 = 0;
                do {
              ...
              if (((uVar15 - 8 >> 3) + 1 & 7) != 0) {
                lVar10 = lVar10 << 2;
                lVar6 = -(unsigned long)((byte)(((byte)(((char)uVar5 + 1U & 0x38) - 8) >> 3) + 1) & 7);
                do {
                  puVar1 = (uint *)((long)puVar9 + lVar10);
                  *puVar1 = param_5;
                  puVar1[1] = param_5;
                  puVar1[2] = param_5;
                  puVar1[3] = param_5;
                  puVar1 = (uint *)((long)puVar8 + lVar10 + 0x50);
                  *puVar1 = param_5;
                  puVar1[1] = param_5;
                  puVar1[2] = param_5;
                  puVar1[3] = param_5;
              ...
              if (uVar14 == uVar15) goto LAB_100203840;
              puVar9 = puVar9 + uVar15;
              iVar12 = iVar12 - (int)uVar15;
            }
            iVar12 = iVar12 + 1;
            do {
              *puVar9 = param_5;
...
LAB_100204170:
          ...
          if (uVar1 != uVar23) goto LAB_100204170;
        }
...
LAB_100204040:
                ...
                if (uVar1 != uVar23) goto LAB_100204040;
              }
...
void Picture::invertAreaUC(int, int, int, int) {
unsigned long uVar1;
  uint *puVar2;
  uint *puVar3;
  int iVar4;
  ...
  if ((param_4 != 0) && (param_3 != 0)) {
    iVar4 = *(int *)(this + 0x38);
    puVar22 = (uint *)((long)((param_2 + *(int *)(this + 100)) * iVar4 +
                             param_1 + *(int *)(this + 0x60)) * 4 + *(long *)(this + 0x30));
    uVar1 = (unsigned long)(param_3 - 1U) + 1;
...
LAB_1002042b0:
        ...
        if (uVar24 - 8 == 0) {
          ...
          lVar23 = 0;
          lVar21 = -(uVar25 & 0xfffffffffffffffe);
          do {
            puVar2 = puVar22 + lVar23;
            uVar5 = puVar2[1];
            uVar6 = puVar2[2];
            uVar7 = puVar2[3];
            puVar3 = puVar22 + lVar23 + 4;
            uVar8 = *puVar3;
            uVar9 = puVar3[1];
            uVar10 = puVar3[2];
            uVar11 = puVar3[3];
            puVar3 = puVar22 + lVar23 + 8;
            uVar12 = *puVar3;
            uVar13 = puVar3[1];
            uVar14 = puVar3[2];
            uVar15 = puVar3[3];
            puVar3 = puVar22 + lVar23 + 0xc;
            uVar16 = *puVar3;
            uVar17 = puVar3[1];
            uVar18 = puVar3[2];
            uVar19 = puVar3[3];
            puVar3 = puVar22 + lVar23;
            *puVar3 = *puVar2 ^ 0xffffff;
            puVar3[1] = uVar5 ^ 0xffffff;
            puVar3[2] = uVar6 ^ 0xffffff;
            puVar3[3] = uVar7 ^ 0xffffff;
            puVar2 = puVar22 + lVar23 + 4;
            *puVar2 = uVar8 ^ 0xffffff;
            puVar2[1] = uVar9 ^ 0xffffff;
            puVar2[2] = uVar10 ^ 0xffffff;
            puVar2[3] = uVar11 ^ 0xffffff;
            puVar2 = puVar22 + lVar23 + 8;
            *puVar2 = uVar12 ^ 0xffffff;
            puVar2[1] = uVar13 ^ 0xffffff;
            puVar2[2] = uVar14 ^ 0xffffff;
            puVar2[3] = uVar15 ^ 0xffffff;
            puVar2 = puVar22 + lVar23 + 0xc;
            *puVar2 = uVar16 ^ 0xffffff;
            puVar2[1] = uVar17 ^ 0xffffff;
            puVar2[2] = uVar18 ^ 0xffffff;
            puVar2[3] = uVar19 ^ 0xffffff;
        ...
        iVar20 = param_3 - (int)uVar24;
        if (uVar1 != uVar24) goto LAB_1002042b0;
      }
      puVar22 = puVar22 + (iVar4 - param_3);
      param_4 = param_4 + -1;
    } while (param_4 != 0);
  }
  return;
...
this[8] = (Picture)0x0;
  ...
  *(void ***)this = &PTR__Picture_1009eb458;
...
unsigned int uVar1;
  ...
  uVar2 = CONCAT31(in_register_00000011,param_3);
  uVar1 = (**(code **)(*(long *)this + 0x78))();
  if ((char)uVar1 != '\0') {
    *(int *)(this + 0x38) = param_2;
    *(unsigned int *)(this + 0x3c) = uVar2;
    if (this[0x4d] == (Picture)0x0) {
      *(unsigned long long *)(this + 0x60) = 0;
    }
    else {
      iVar3 = (int)*(unsigned long long *)(this + 0x60);
      iVar4 = (int)((unsigned long)*(unsigned long long *)(this + 0x60) >> 0x20);
      ...
      _local_38 = CONCAT44(iVar4 + iStack_34,iVar3 + local_38);
      _iStack_30 = CONCAT44(iVar4 + iStack_2c,iVar3 + iStack_30);
      *(unsigned long long *)(this + 0x60) = 0;
      setClipRect(this,(Rect *)&local_38);
      param_2 = *(int *)(this + 0x38);
      uVar2 = *(unsigned int *)(this + 0x3c);
    }
    this[0x4d] = (Picture)0x0;
    *(unsigned long long *)(this + 0x50) = 0;
    *(int *)(this + 0x58) = param_2;
    *(unsigned int *)(this + 0x5c) = uVar2;
  }
  return uVar1;
}
