...
LAB_100309d96:
      ...
      if (*param_1 == '/') goto LAB_100309dd8;
      if (((byte)pVar1 & 1) != 0) goto LAB_100309db7;
    }
    if ((byte)pVar1 < 2) goto LAB_100309dd8;
    ...
    if (*param_1 == '/') goto LAB_100309dd8;
LAB_100309db7:
    if (*(long *)(this + 8) == 0) goto LAB_100309dd8;
...
path *ppVar1;
  ...
  if (uVar7 != 0) {
    uVar6 = uVar7;
    if (*ppVar1 != (path)0x2f) goto joined_r0x00010030a45c;
    if ((1 < uVar7) && (ppVar1[1] == (path)0x2f)) {
      uVar6 = 2;
      if (uVar7 == 2) goto joined_r0x00010030a45c;
      if (ppVar1[2] != (path)0x2f) {
        ...
        uVar6 = sVar8 + 2;
        goto joined_r0x00010030a45c;
      }
    }
  }
  uVar6 = 0;
joined_r0x00010030a45c:
  if (((byte)pVar3 & 1) == 0) {
  ...
  else if (uVar6 < *(unsigned long *)(this + 8)) {
    do {
...
unsigned long long uVar1;
  ...
  if ((*in_RSI & 1) == 0) {
    ...
    if (uVar13 == 0) goto LAB_100307073;
LAB_100307049:
    uVar12 = 0;
    if ((uVar13 == 1) || (*pbVar8 != 0x2f)) goto LAB_100307076;
    if (pbVar8[1] != 0x2f) goto LAB_100307073;
    uVar12 = 2;
    if (uVar13 == 2) goto LAB_100307076;
    if (pbVar8[2] == 0x2f) goto LAB_100307073;
    sVar14 = uVar13 - 2;
    ...
    if (uVar12 < 0x17) goto LAB_10030707a;
    uVar13 = sVar14 + 0x12 & 0xfffffffffffffff0;
    pbVar4 = (byte *)new(uVar13);
    ...
    *in_RDI = uVar13 | 1;
    ...
    if (uVar13 != 0) goto LAB_100307049;
LAB_100307073:
    uVar12 = 0;
LAB_100307076:
...
LAB_10030707a:
    *(char *)in_RDI = (char)uVar12 * '\x02';
    ...
    if (uVar12 == 0) goto LAB_1003071a2;
    uVar13 = (long)pbVar11 - (long)pbVar8;
  }
  if ((0x1f < uVar13) && ((pbVar11 <= pbVar4 || (pbVar4 + uVar13 <= pbVar8)))) {
    ...
    if (uVar10 == uVar13) goto LAB_1003071a2;
...
byte bVar1;
  ...
  if ((bVar1 & 1) == 0) {
    ...
    if (uVar14 == 0) goto LAB_100307ef4;
LAB_100307ecc:
    if (*pbVar8 != 0x2f) {
      uVar13 = 0;
      uVar11 = uVar14;
      goto joined_r0x000100307f0b;
    }
    if ((uVar14 < 2) || (pbVar8[1] != 0x2f)) goto LAB_100307ef4;
    uVar13 = 2;
    uVar11 = 2;
    if (uVar14 == 2) goto joined_r0x000100307f0b;
    if (pbVar8[2] == 0x2f) goto LAB_100307ef4;
    sVar15 = uVar14 - 2;
    ...
    uVar11 = sVar15 + 2;
    uVar13 = uVar11;
    if ((bVar1 & 1) == 0) goto LAB_100307f0d;
LAB_100307f51:
    ...
    uVar14 = *(unsigned long *)(in_RSI + 8);
    pbVar8 = *(byte **)(in_RSI + 0x10);
    if (uVar14 != 0) goto LAB_100307ecc;
LAB_100307ef4:
    uVar13 = 0;
    uVar11 = 0;
joined_r0x000100307f0b:
    if ((bVar1 & 1) != 0) goto LAB_100307f51;
LAB_100307f0d:
    uVar14 = (unsigned long)(bVar1 >> 1);
  }
  if (uVar11 < uVar14) {
  ...
  if (uVar13 < 0x17) {
    *(char *)in_RDI = (char)uVar13 * '\x02';
    ...
    if (uVar13 == 0) goto LAB_1003080d2;
  }
  else {
    uVar14 = uVar13 + 0x10 & 0xfffffffffffffff0;
    pbVar6 = (byte *)new(uVar14);
  ...
  if ((0x1f < uVar13) && ((pbVar8 + uVar13 <= pbVar6 || (pbVar6 + uVar13 <= pbVar8)))) {
    ...
    if (uVar13 == uVar11) goto LAB_1003080d2;
