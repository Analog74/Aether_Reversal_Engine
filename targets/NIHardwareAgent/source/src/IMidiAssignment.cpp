...
LAB_10009aeee:
    if (param_2 != 0xf2) goto LAB_10009aefd;
LAB_10009af84:
    uVar3 = 0;
    uVar5 = 0;
LAB_10009af86:
...
LAB_10009afc1:
    ...
    if (iVar4 == 0xfc) {
      *(unsigned int *)(this + 0x7c) = 0x7f;
      ...
      if (iVar4 != 0xe0) goto LAB_10009aeee;
      *(unsigned long long *)(this + 0x8c) = 0;
    }
    if (param_2 == 0xf2) goto LAB_10009af84;
LAB_10009aefd:
    uVar3 = 0;
    if (param_2 == 0xe0) {
    ...
    *(int *)(this + 0x84) = param_2;
    ...
    if (param_2 != 0x12) {
      if (param_2 == 0x11) {
        ...
        iVar4 = *(int *)(this + 0x8c);
        goto joined_r0x00010009b28c;
      }
      if (param_2 == 0x10) goto LAB_10009af4a;
      goto LAB_10009afb6;
    }
LAB_10009af4a:
    this[0xa1] = (Assignment)0x0;
    iVar4 = *(int *)(this + 0x8c);
joined_r0x00010009b28c:
    if (-1 < iVar4) goto LAB_10009afc1;
LAB_10009af5d:
  ...
  else if (((param_2 - 0x12U < 2) || (param_2 == 0xf2)) || (param_2 == 0xe0)) {
    if (0x3fff < iVar4) {
      *(unsigned int *)(this + 0x94) = 0x3fff;
    }
  }
...
LAB_10009b10f:
    ...
    if ((uVar1 - 2 < 2) || (uVar1 == 5)) {
      if (*(int *)(this + (unsigned long)((uVar1 & 0xfffffffe) != 2) * 8) - 1U < 2) goto LAB_10009b10f;
    }
    else if ((uVar1 == 0) &&
            (((*(uint *)(this + 0x70) & 8) != 0 ||
  ...
  if ((uVar1 < 6) && ((0x2cU >> (uVar1 & 0x1f) & 1) != 0)) {
    ...
    if (iVar4 < 0xfa) {
      ...
      if (2 < iVar4 - 0xfaU) goto LAB_10009b2af;
      uVar8 = 1;
    }
    setButtonBehavior(this,uVar8,1);
    uVar1 = *(uint *)(this + 0x60);
