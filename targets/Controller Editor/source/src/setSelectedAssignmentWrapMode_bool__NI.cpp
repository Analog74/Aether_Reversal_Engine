#include <ni/controller_editor/setSelectedAssignmentWrapMode_bool__NI.hpp>
#include "../../../../dynamic_headers/ni_common_types.h"
namespace NI::Model {

void setSelectedAssignmentWrapMode(1 param_1, bool, NI::AssignmentActionType {
long lVar1;
  uint uVar2;
  long lVar3;
  ...
  if (lVar3 != lVar1) {
    do {
      *(unsigned char *)(lVar3 + 0xa3 + (param_3 & 0xff) * 0xa8) = param_1;
      lVar3 = lVar3 + 0x1f8;
    } while (lVar1 != lVar3);
  }
