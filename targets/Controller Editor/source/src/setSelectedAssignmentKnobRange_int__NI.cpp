#include <ni/controller_editor/setSelectedAssignmentKnobRange_int__NI.hpp>
#include "../../../../dynamic_headers/ni_common_types.h"
namespace NI::Model {

void setSelectedAssignmentKnobRange(1 param_1, int, NI::AssignmentActionType {
long lVar1;
  uint uVar2;
  long lVar3;
  int iVar4;
  ...
  if (lVar3 != lVar1) {
    ...
    do {
      *(int *)(lVar3 + (param_3 & 0xff) * 0xa8) = iVar4;
      lVar3 = lVar3 + 0x1f8;
    } while (lVar1 != lVar3);
  }
