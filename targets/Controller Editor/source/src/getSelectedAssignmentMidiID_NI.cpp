#include <ni/controller_editor/getSelectedAssignmentMidiID_NI.hpp>
#include "../../../../dynamic_headers/ni_common_types.h"
namespace NI::Model {

void getSelectedAssignmentMidiID(NI::AssignmentActionType) {
long lVar1;
  byte bVar2;
  byte bVar3;
  uint uVar4;
  ...
  if (lVar6 == lVar1) {
    ...
    bVar3 = 0;
    do {
      bVar2 = *(byte *)(lVar6 + 0xa1 + (param_2 & 0xff) * 0xa8);
