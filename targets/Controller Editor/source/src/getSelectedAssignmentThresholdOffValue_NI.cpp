#include <ni/controller_editor/getSelectedAssignmentThresholdOffValue_NI.hpp>
#include "../../../../dynamic_headers/ni_common_types.h"
namespace NI::Model {

void getSelectedAssignmentThresholdOffValue(NI::AssignmentActionType) const {
long lVar1;
  uint uVar2;
  long lVar3;
  uint uVar4;
  ...
  if (lVar3 == lVar1) {
    ...
    uVar2 = 0;
    do {
      uVar4 = (uint)(*(float *)(lVar3 + 4 + (param_2 & 0xff) * 0xa8) * 100.0);
      if ((int)uVar4 < 0) {
        uVar4 = 0;
      }
