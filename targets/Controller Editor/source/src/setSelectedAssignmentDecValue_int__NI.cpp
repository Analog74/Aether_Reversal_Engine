#include <ni/controller_editor/setSelectedAssignmentDecValue_int__NI.hpp>
#include "../../../../dynamic_headers/ni_common_types.h"
namespace NI::Model {

void setSelectedAssignmentDecValue(1 param_1, int, NI::AssignmentActionType {
long lVar1;
  uint uVar2;
  ...
  if (lVar3 != lVar1) {
    do {
      *(unsigned int *)(lVar3 + 0x9c + (param_3 & 0xff) * 0xa8) = param_1;
      lVar3 = lVar3 + 0x1f8;
    } while (lVar1 != lVar3);
  }
