...
void readTemplatePropertyAttributes(1 param_1, pugi::xml_node const& {
uint uVar1;
  char cVar2;
  unsigned int uVar3;
  int iVar4;
  ...
  if (MapProperty::s_mapPropertiesToNames != &0) {
    do {
      local_38 = pugi::xml_node::attribute((xml_node *)param_1,(char *)puVar15[5]);
      p_Var5 = pugi::xml_attribute::operator_cast_to_function_pointer((xml_attribute *)&local_38);
      if (p_Var5 == (_func_void_xml_attribute_ptr_ptr_ptr *)0x0) return;
...
joined_r0x0001002f636b:
        if (puVar11 == (unsigned long long *)0x0) return;
        do {
          puVar8 = puVar11;
        ...
        if (uVar1 == 0x4d704d70) {
          ...
          *(unsigned char *)((long)pvVar9 + sVar7) = 0;
          ...
          if (0 == (unsigned long long *)0x0) return;
          puVar8 = &0;
          puVar11 = 0;
          do {
