#include <ni/controller_editor/setSelectedAssignmentTouchstripMode_unsigned_int__NI.hpp>
#include "../../../../dynamic_headers/ni_common_types.h"
namespace NI::Model {

void setSelectedAssignmentTouchstripMode(2 param_2, unsigned int, NI::AssignmentActionType {
long lVar1;
  uint uVar2;
  ...
  if (lVar3 != lVar1) {
    do {
      *(void2 *)(lVar3 + 8 + (param_3 & 0xff) * 0xa8) = param_2;
      lVar3 = lVar3 + 0x1f8;
    } while (lVar1 != lVar3);
  }
  IAssignmentSupport::updateSelectedAssignments((IAssignmentSupport *)this);
  uStack_28 = CONCAT17(1,(void7)uStack_28);
