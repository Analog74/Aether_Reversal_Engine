...
char cVar1;
  ...
  void *local_40;
  tSelectorRelations *local_38;
  
  local_50 = (string)0xe;
  local_4f = 0x626d7973;
  uStack_4b = 0x736c6f;
  local_48 = 0;
  *(tSelectorRelations **)this = this;
  *(tSelectorRelations **)(this + 8) = this;
  *(tSelectorRelations **)(this + 0x10) = this;
  ...
  *(char **)pcVar5 = pcVar3;
  ...
  do {
    ...
    if (pcVar7 == "") {
      if (*(long *)(pcVar3 + 8) == 0) {
        puVar4 = (unsigned char *)new char[1];
        *puVar4 = 1;
        *(unsigned char **)(pcVar3 + 8) = puVar4;
      }
