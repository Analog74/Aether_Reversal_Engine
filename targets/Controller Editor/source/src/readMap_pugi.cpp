...
void readMap(1 param_1, pugi::xml_node const&, bool {
ControllerMap CVar1;
  char cVar2;
  int iVar3;
  unsigned int uVar4;
  ...
  if (cVar2 != '\0') {
    ...
    if (uVar11 == sVar7) {
      ...
      local_50 = pugi::xml_node::attribute((xml_node *)param_1,"name");
      ...
      goto joined_r0x0001002ded9c;
    }
  }
  uVar4 = 0;
joined_r0x0001002ded9c:
  if ((local_48 & 1) != 0) {
    delete(local_38);
  }
  return uVar4;
