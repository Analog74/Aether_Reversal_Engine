#include <ni/controller_editor/getSelectedAssignmentMidiType_NI.hpp>
#include "../../../../dynamic_headers/ni_common_types.h"
namespace NI::Model {

void getSelectedAssignmentMidiType(NI::AssignmentActionType) {
long lVar1;
  uint uVar2;
  uint uVar3;
  long lVar4;
  ...
  if (lVar4 == lVar1) {
    ...
    uVar2 = 0;
    do {
      uVar3 = *(uint *)(lVar4 + 0x84 + (param_2 & 0xff) * 0xa8);
