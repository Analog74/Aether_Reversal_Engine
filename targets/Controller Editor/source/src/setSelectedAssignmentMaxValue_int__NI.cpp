#include <ni/controller_editor/setSelectedAssignmentMaxValue_int__NI.hpp>
#include "../../../../dynamic_headers/ni_common_types.h"
namespace NI::Model {

void setSelectedAssignmentMaxValue(3 param_3, int, NI::AssignmentActionType {
long lVar1;
  uint uVar2;
  int iVar3;
  unsigned int uVar4;
      ...
      do {
        *(int *)(pAVar5 + 0x94) = param_1;
        ...
        if (((iVar3 - 0x12U < 2) || (iVar3 == 0xe0)) ||
          ...
          *(unsigned int *)(pAVar5 + 0x94) = uVar4;
        }
        iVar3 = NHL2::Assignment::boundValueToMinMax(pAVar5,*(int *)(pAVar5 + 0x7c));
        NHL2::Assignment::setMidiValue(pAVar5,iVar3,true);
        pAVar5 = pAVar5 + 0x1f8;
