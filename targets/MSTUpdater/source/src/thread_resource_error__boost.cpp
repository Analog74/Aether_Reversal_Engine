#include <ni/controller_editor/thread_resource_error__boost.hpp>
namespace void boost::throw_exception<boost {

void thread_resource_error>(boost::thread_resource_error const&) {
clone_impl<// boost code
  ...
  local_50 = 0;
  local_38 = 0xffffffff;
  local_90[0] = PTR_vtable_100227228 + 0x10;
  local_58 = PTR_vtable_100227228 + 0x38;
  exception_detail::
  clone_impl<// boost code
            (this,(error_info_injector *)local_90);
                    /* WARNING: Subroutine does not return */
  ___cxa_throw(this,PTR_typeinfo_100227150,
               exception_detail::
               clone_impl<// boost code
               ::~clone_impl);
}
