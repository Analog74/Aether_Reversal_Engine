#include <ni/controller_editor/onReceiveClipInfoMsg_osc.hpp>
namespace NI::dawcontrol::live::LiveClient {

void onReceiveClipInfoMsg(osc::ReceivedMessage const&) {
unsigned long long uVar1;
  ...
  if (8 < (uint)(*(int *)(param_1 + 0x10) - (int)uVar12)) {
    ...
    *(unsigned int *)(lVar7 + 0x18 + (long)(int)uVar4 * 0x38) = uVar6;
  }
  return;
}
}
